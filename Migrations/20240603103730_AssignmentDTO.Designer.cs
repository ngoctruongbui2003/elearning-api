...
namespace ElearningAPI.Migrations
{
    ...
    [Migration("20240603103730_AssignmentDTO")]
    partial class AssignmentDTO
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElearningAPI.Datas.ClassroomCreate", b =>
                {
                    ...
                    b.ToTable("ClassroomCreates");
                });

            modelBuilder.Entity("ElearningAPI.Datas.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElearningAPI.Datas.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElearningAPI.Datas.UploadFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElearningAPI.Datas.Comment", b =>
                {
                    b.HasOne("ElearningAPI.Datas.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ElearningAPI.Datas.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
